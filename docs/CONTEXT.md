...
1. **Static Analysis Evasion**: Replaces `OBFUSCATE("...")` blocks inside core scripts with base64-reversed strings during the build phase to evaluate static AST scanners.
